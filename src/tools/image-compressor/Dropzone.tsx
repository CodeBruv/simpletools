...
import { ACCEPTED_EXTENSIONS, ACCEPTED_LABEL, ACCEPTED_MIME_TYPES, MAX_BYTES } from '@/tools/image-compressor/compressImage'
...
export default function Dropzone({ onFile, error, disabled = false }: DropzoneProps) {
    ...
    <div>
      ...
      >
        ...
        <p className="mt-4 text-base font-medium text-ink">
          {dragging ? 'Drop to compress' : 'Drop an image here'}
        </p>
      ...
      <div className="mt-4">
        <PrivacyNote>
          Your images stay on your device. They are processed locally in your browser, and are never
