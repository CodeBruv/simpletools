...
const MUST_BE_LAZY = [
  ...
  'src/tools/image-converter/ImageConverter.tsx',
  'src/tools/image-converter/convertImage.ts',
  'src/tools/image-resizer/ImageResizer.tsx',
  'src/tools/image-resizer/ResizerDropzone.tsx',
  'src/tools/image-resizer/resizeImage.ts',
  'src/tools/json-formatter/JsonFormatter.tsx',
  'src/tools/json-formatter/formatJson.ts',
  'src/tools/password-generator/PasswordGenerator.tsx',
  'src/tools/password-generator/generatePassword.ts',
  'src/tools/pdf-merger/PdfMerger.tsx',
  'src/tools/pdf-merger/mergePdfs.ts',
